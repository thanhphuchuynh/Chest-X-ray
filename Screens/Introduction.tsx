...
import { IntroductionScreenNavigationProp } from '../Navigation/StackNavigation';
...
const Pagination = ({ scrollX, onPress }: PaginationProps) => {
  const inputRange = [-width, 0, width];
...
const Introduction: React.FC<OnboardingScreenProps> = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Pagination
        scrollX={scrollX}
        onPress={() => navigation.navigate('PortScreen')}
      />
